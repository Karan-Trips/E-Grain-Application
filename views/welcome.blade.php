      ...
      <div class="form">
        <div class="login">
          <div class="login-header">
            <h3>LOGIN TO GRAIN-E</h3>
            <p>Please enter your credentials to login.</p>
          </div>
        </div>
        <form class="login-form" action="/show" method="GET">
          <input type="text" placeholder="username" required  name="uname" />
          <input type="password" placeholder="password" name="pwd" required />
          <button>login</button>
          <p class="message">Forgot password? <a href="/forgot">Click here</a></p>
        </form>
      </div>
    </div>
</body>
