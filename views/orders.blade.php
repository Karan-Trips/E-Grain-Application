...
<center>
			<h1 align="center">Grain MANAGEMENT</h1>
			<br><br><br>
		<form style="align-items: center;">
			<a href="/home" style="font-size:150%">Add Product</a>
				<hr>
				<br>
				<button type="submit" style="font-size:130%; background-color: red;"><a href="/home">ADD</a></button>&nbsp;

				<button type="submit" style="font-size:130%; background-color: yellow;"><a href="/edit">UPDATE</a></button>&nbsp;
				<button type="submit" style="font-size:130%; background-color: grey;"><a href="/del">DELETE</a></button>&nbsp;
				<button onclick="window.print()" style="font-size:130%; background-color: aqua;">PRINT</button>
&nbsp;
		</form>
		<br><br><br>
